...
\documentclass[print,thumbmain]{src/PhdThesisMarijn}  % uncomment for writing
...
%%%% FRONT MATTERS *************************************************************
\cover{thesis_front.pdf}   
% Adds your thesis' front cover if the option 'print' is NOT used.
% Printing companies require the thesis cover to be supplied separately and in a different format.
% Definition of \cover{} is given in commands.tex.
...
\include{3_chapters/2_dummy_chapter/dummy_2}
